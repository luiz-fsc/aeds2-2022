...
public class TP03Q11 {
     ...
     */
    public static void doComands(String s, Pilha pilha) {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int num = Integer.parseInt(leitor.nextLine());//quantidade de comandos a serem lidos nas proximas "num" linhas
        for(int i = 0; i < num; i++){

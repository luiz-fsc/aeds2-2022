...
public class TP02Q06{
    ...
    public static void main(String[] args) throws Exception{
        ...
        for(int i = 1; i <= num; i++){
            filmes.doComands(leitor.nextLine());
        }
...
class Pilha{
     ...
     * @param tamanho Tamsanho da lista.
     */
    Pilha(int tamanho){
    ...
    public void push(Film x) throws Exception{
        if(n >= array.length){
    ...
    public Film pop() throws Exception{
        if(n == 0){
    ...
    public void doComands(String s){
        ...
        if(aux[0].charAt(0) == 'I'){
            ...
            try {
                System.out.println("(R) " + pop().getName());    
            } catch (Exception e) {}
        }
    }
}
